...
@jax.jit
def compute_spline_constraints_for_bez(
    controlPoints,
    knotPoints,
    evaderSpeed,
    pursuerPosition,
...
dBEZDControlPoints = jax.jit(jacfwd(bez_along_spline, argnums=0))
dBEZDtf = jax.jit(jacfwd(bez_along_spline, argnums=1))


def optimize_spline_path_BEZ(
    p0,
    pf,
    v0,
    num_cont_points,
...
def plan_path_BEZ(
    ...
    (splineRight, tfRight) = optimize_spline_path_BEZ(
        initialEvaderPosition,
        finalEvaderPosition,
        initialEvaderVelocity,
    ...
    splineLeft, tfLeft = optimize_spline_path_BEZ(
        initialEvaderPosition,
        finalEvaderPosition,
        initialEvaderVelocity,
        num_cont_points=num_cont_points,
